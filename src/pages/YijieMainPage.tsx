                    ...
                    <div className="flex-1 flex flex-col pl-20 h-full">
                        <div className="text-center mb-12 mt-20">
                            ...
                            <div className="flex flex-col items-center justify-center h-full pb-6">
                                <div className="w-3/4 bg-blue-200/50 rounded-t-3xl p-8 shadow-[0_0_30px_rgba(59,130,246,0.3)] border border-blue-300 h-[800px] overflow-auto flex flex-col justify-between">
                                    {/* 对话区域 */}
